    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Original Language",
                           value = 2,
                           br(),
                           h4(strong("This graph plots the revenue of movies by original language.")),
                           plotOutput("language.plot", 
                                      hover = "language.hover"),
                           h4(strong(em("Notes about the bar chart"))),
                           ...
                           h4(strong("Hover over the bar graph with your mouse to view the revenue at that point.")),
                           em("Values are listed in US dollar"),
                           verbatimTextOutput("language.info"),
                           br(),
                           h4(strong("Viewing statistics for a specific language.")),
                           ...
                           br(),
                           h4(strong("Analyzing the bar graph")),
                           ...
                           br(),
                           p(strong("The Statistical Significance Between Original Language and Revenue")),
                           verbatimTextOutput("p.lang"),
                           p("From the original dataset, a One Way Analysis of Variance (ANOVA) test was run between
                             original language and revenue revealing a p-value of 0.041. Because the p-value is < 0.05, original language
                             and revenue can therefore be considered a statistically significant factor.")
